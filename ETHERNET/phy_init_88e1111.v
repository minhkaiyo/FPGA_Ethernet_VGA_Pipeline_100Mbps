...
module phy_init_88e1111 #(
    ...
    localparam F_HWRST=0, F_HWWAIT=1, F_SCAN=2, F_SCAN_W=3, F_RD20=4, F_RD20W=5, F_WR20=6, F_WR20W=7, F_WR9=8, F_WR9W=9, F_WR0=10, F_WR0W=11, F_DONE=12;
    reg [3:0] fsm=0;
    reg [24:0] timer=0;
    reg [4:0] mio_reg;
    reg mio_is_wr;
    ...
    always @(posedge clk or negedge rst_n) begin
        if(!rst_n) begin
            ...
            case(fsm)
                ...
                F_WR20W: if(mio_done) fsm<=F_WR9;
                F_WR9: if(mio_done) begin mio_reg<=9; mio_is_wr<=1; mio_wr_data<=16'h0300; mio_start<=1; fsm<=F_WR9W; end
                F_WR9W: if(mio_done) fsm<=F_WR0;
                // Khong dung Soft-Reset (0x9140) de tranh mat hardware strap. Chi bat AN va Restart AN (0x1140)
                F_WR0: if(mio_done) begin mio_reg<=0; mio_is_wr<=1; mio_wr_data<=16'h1140; mio_start<=1; fsm<=F_WR0W; end
